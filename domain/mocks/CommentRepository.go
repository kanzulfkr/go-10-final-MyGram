...
func (_m *CommentRepository) Get(_a0 context.Context, _a1 *[]domain.Comment, _a2 string) error {
...
func (_m *CommentRepository) Create(_a0 context.Context, _a1 *domain.Comment) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *CommentRepository) Edit(_a0 context.Context, _a1 domain.Comment, _a2 string) (domain.Image, error) {
	ret := _m.Called(_a0, _a1, _a2)

	var r0 domain.Image
	if rf, ok := ret.Get(0).(func(context.Context, domain.Comment, string) domain.Image); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
