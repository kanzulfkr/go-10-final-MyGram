...
func (_m *SocialMediaUseCase) Get(_a0 context.Context, _a1 *[]domain.SocialMedia, _a2 string) error {
...
func (_m *SocialMediaUseCase) Create(_a0 context.Context, _a1 *domain.SocialMedia) error {
	ret := _m.Called(_a0, _a1)
...
func (_m *SocialMediaUseCase) Edit(_a0 context.Context, _a1 domain.SocialMedia, _a2 string) (domain.SocialMedia, error) {
	ret := _m.Called(_a0, _a1, _a2)
