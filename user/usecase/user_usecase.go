...
func (userUseCase *userUseCase) Edit(ctx context.Context, user domain.User) (u domain.User, err error) {
	if u, err = userUseCase.userRepository.Edit(ctx, user); err != nil {
		return u, err
	}
